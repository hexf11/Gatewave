...
- 提供均衡、极速、省电三档模式；极速模式启用 Wi-Fi 低延迟锁，温度严重时自动降级并回收缓冲池。
...
- 提供 TCP、UDP、订阅、VPN、出口地址和数据面容量等一键网络自检；分享报告隐藏具体网络地址。
- 提供峰值、活跃设备、DNS、建连 P50/P95、实时吞吐、UDP 丢弃、公平回收、Selector 与缓冲池指标。
